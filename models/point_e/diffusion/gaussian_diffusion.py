...
class GaussianDiffusion:
    ...
    def p_mean_variance(
        ...
        model_output = model(partial, x, t, **model_kwargs)
    ...
    def _vb_terms_bpd(
        self, partial, model, x_start, x_t, t, clip_denoised=False, model_kwargs=None
    ):
        """
    ...
    def training_losses(
        self, partial, model, x_start, t, model_kwargs=None, noise=None
    ) -> Dict[str, th.Tensor]:
        """
        ...
        if self.loss_type == "kl" or self.loss_type == "rescaled_kl":
            ...
            model_output = model(partial, x_t, t, **model_kwargs)
            if isinstance(model_output, tuple):
                model_output, extra = model_output
            else:
                extra = {}
            ...
            target = {
                "x_prev": self.q_posterior_mean_variance(x_start=x_start, x_t=x_t, t=t)[
                    0
                ],
                "x_start": x_start,
                "epsilon": noise,
