...
def get_args():
    ...
    parser.add_argument("--save_path", type=str, default="/partial_200/")
    parser.add_argument("--text_type", type=str, default="GT")

    parser.add_argument("--seed", type=int, default=500, help="random seed")
    parser.add_argument(
        "--mask_ratio", type=float, default=1, help="mask ratio for infer"
    )
    parser.add_argument(
        "--deterministic",
        action="store_true",
    ...
    parser.add_argument(
        "--demo", action="store_true", default=False, help="demo mode for certain ckpt"
    )
    parser.add_argument(
        "--mode",
